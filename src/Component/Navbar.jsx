      ...
      <div id="navbar" className="navbar bg-base-100">
        <div className="navbar-start">
          <div className="dropdown">
            ...
            <ul
              ...
              <li>
                <Link to="/Berita" className="text-rose-600">Berita</Link>
              </li>
              <li>
                <a>Profil</a>
                <ul className="p-2">
                  <li>
                    <Link to="/SelayangPandang">Selayang Pandang</Link>
                  </li>
                  <li>
              ...
              <li>
                <Link to="/Kalender">Kalender even</Link>
              </li>
            </ul>
          </div>
        ...
        <div className="navbar-center hidden lg:flex">
          <ul className="menu menu-horizontal px-1">
            ...
            <li>
              <Link to="/Pengumuman">Pengumumuman</Link>
            </li>
            <li>
              <Link to="/Kalender">Kalender Even</Link>
            </li>
